...
argglobal
balt src/components/Select/CheckBox.tsx
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
if &buftype ==# 'terminal'
  silent file src/components/Select/SelectComponent.tsx
endif
balt src/components/Select/CheckBox.tsx
setlocal fdm=manual
setlocal fde=0
...
badd +3 dist/index.js
badd +1 list:///lists
badd +8 list:///extensions
