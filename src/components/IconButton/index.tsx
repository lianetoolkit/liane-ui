...
export const IconButton: FC<IconButtonProps> = ({
  ...
  switch (color) {
    case 'primary':
      extraClasses += `${extraClasses === '' ? `text-grey-800` : ''
        } hover:bg-gray-100 focus:bg-gray-200`;
      if (shaped) extraClasses += ` ${inverse ? `bg-white` : `bg-gray-100`} `;
      break;
    case 'secondary':
      extraClasses += `${extraClasses === '' ? `text-gray-500` : ''
        }  hover:bg-gray-100 focus:bg-gray-200`;
      if (shaped) extraClasses += ' bg-gray-100';
      break;
    case 'destructive':
      extraClasses += `${extraClasses === '' ? `text-red-500` : ''
        }  hover:bg-gray-100 focus:bg-gray-200`;
      if (shaped) extraClasses += ' bg-gray-100';
      break;
    default:
      extraClasses += `${extraClasses === '' ? `text-purple-500` : ''
  ...
  const finalClasses = `${base} ${disabled ? `text-gray-300 ${shaped && `bg-gray-100`}` : extraClasses
    } `;
  return (
    <button
      disabled={disabled}
